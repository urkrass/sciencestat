...
export function FormulaStrip({ children }: FormulaStripProps) {
  return (
    <div className="rounded-md border border-line bg-paper px-3 py-2 text-xs font-semibold text-slate-700">
      {children}
    </div>
  );
}
...
export function TryThisPrompt({ children }: TryThisPromptProps) {
  return (
    <p className="rounded-md border border-line bg-white/80 px-3 py-2 text-xs leading-5 text-slate-600">
